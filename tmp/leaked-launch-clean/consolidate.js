...
const CREATOR_BUFFER = 890880; // rent-exempt min for system account
...
(async () => {
  ...
  console.log('Leaked: ', creatorBal/1e9, 'SOL');
  ...
  // Creator drain: pre-bal + vault collected - rent-exempt buffer
  const creatorDrain = creatorBal + vaultBal - CREATOR_BUFFER;
  ...
  console.log('Leaked drain to dest:', creatorDrain/1e9, 'SOL');
